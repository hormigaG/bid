...
export class PrinterService {
	...
	printText(stringToPrint : string = "String to Print",size: string='0', align: string = '0') {
		const printOBS = new Observable((observer) => {
	...
	printBarcode(system : string, data :string, align : string = '1', position: string ='2', font: string = '0', height: string = '64') {
		const printOBS = new Observable((observer) => {
	...
	printQRCode( data :string, align : number, model: number = 49, size: number = 32, eclevel: number = 50) {
		const printOBS = new Observable((observer) => {
